...
<html>
    ...
    <body>
        ...
        <button class="account" id="savechanges" onclick="redirectTo('accountlist.jsp')">Save Changes</button>
        <button class="account" id="cancel" onclick="redirectTo('accountlist.jsp')">Cancel</button>
    </body>
</html>
